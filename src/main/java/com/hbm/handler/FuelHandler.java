...
public class FuelHandler implements IFuelHandler {
	...
	public int getBurnTime(ItemStack fuel) {
		...
		//why the fuck are presto logs made from tatb and ...... BOOOOOOB YOU FUCK Ok it is fixed
		...
		//hey BUDDY, this should produce PHOSGENE GAS AND KILL YOU IF NOT EXPLODE.
		...
		if(fuel.getItem() == ModItems.coke)									return single * 24;
		if(fuel.getItem() == ModItems.powder_coke)							return single * 24;
		if(fuel.getItem() == Item.getItemFromBlock(ModBlocks.block_coke))	return single * 220;
