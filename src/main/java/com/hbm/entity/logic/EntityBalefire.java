...
public class EntityBalefire extends EntityExplosionChunkloading  {
	//actually too much trouble to remove, I really fucking hate EVERY last fucking MLP reference in this mod.
	//this bob guy is a toxic bronie obsessed lurker who is only propped up by all the cock gobbling demons
	//that constantly screech my name every few hours in their reddit think tank hug box of a discord server.
	//I will NEVER have any respect for ANY of you other than like mellow james and drilgon as the spacefork is the one line of separation
	//where it's like holy shit, fucking finally something not generic reddit tumor shit.
