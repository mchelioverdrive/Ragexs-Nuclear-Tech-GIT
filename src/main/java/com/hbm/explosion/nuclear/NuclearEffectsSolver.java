...
public final class NuclearEffectsSolver {
	...
	public static NuclearEffectsProfile solve(NuclearDetonationSpec spec) {
		...
		if(spec.burstType == BurstType.UNDERWATER) {
			// Ground coupling is already present in the base crater calculation. Do not
			// square it here: depth affects the surface plume, bottom distance affects coupling.
