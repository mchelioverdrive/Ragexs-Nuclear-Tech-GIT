...
public class SpaceConfig {
	...
	public static boolean enablePlanetRingRendering = true;
	...
	public static void loadFromConfig(Configuration config) {
		...
		enablePlanetRingRendering = CommonConfig.createConfigBool(config, CATEGORY_GENERAL, "1.92_enablePlanetRingRendering", "Client-side only: render presentation-only rings for ringed planets in celestial skies", enablePlanetRingRendering);
