...
public class WorldConfig {
	...
	public static void loadFromConfig(Configuration config) {
		...
		craterBiomeRad = (float) CommonConfig.createConfigDouble(config, CATEGORY_BIOMES, "17.R00_craterBiomeRad", "Sv/s for the crater biome", 5D);
		craterBiomeInnerRad = (float) CommonConfig.createConfigDouble(config, CATEGORY_BIOMES, "17.R01_craterBiomeInnerRad", "Sv/s for the inner crater biome", 25D);
		craterBiomeOuterRad = (float) CommonConfig.createConfigDouble(config, CATEGORY_BIOMES, "17.R02_craterBiomeOuterRad", "Sv/s for the outer crater biome", 0.5D);
		craterBiomeWaterMult = (float) CommonConfig.createConfigDouble(config, CATEGORY_BIOMES, "17.R03_craterBiomeWaterMult", "Multiplier for Sv/s in crater biomes when in water", 5D);
