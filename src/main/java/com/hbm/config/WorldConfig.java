...
public class WorldConfig {
	...
	public static int polluciteSpawn = 4;
	public static int magnesiteSpawn = 6;
	...
	public static int celestiteSpawn = 4;
	...
	public static boolean enableMeteorStrikes = false;
	public static boolean enableMeteorShowers = false;
	public static boolean enableMeteorTails = false;
	public static boolean enableSpecialMeteors = false;
	...
	public static void loadFromConfig(Configuration config) {
		...
		polluciteSpawn = CommonConfig.createConfigInt(config, CATEGORY_OREGEN, "2.NEW_polluciteSpawnrate", "Amount of pollucite ore veins per chunk", 4);
		...
		craterBiomeRad = (float) CommonConfig.createConfigDouble(config, CATEGORY_BIOMES, "17.R00_craterBiomeRad", "mSv/s for the crater biome", 5D);
		craterBiomeInnerRad = (float) CommonConfig.createConfigDouble(config, CATEGORY_BIOMES, "17.R01_craterBiomeInnerRad", "mSv/s for the inner crater biome", 25D);
		craterBiomeOuterRad = (float) CommonConfig.createConfigDouble(config, CATEGORY_BIOMES, "17.R02_craterBiomeOuterRad", "mSv/s for the outer crater biome", 0.5D);
		craterBiomeWaterMult = (float) CommonConfig.createConfigDouble(config, CATEGORY_BIOMES, "17.R03_craterBiomeWaterMult", "Multiplier for mSv/s in crater biomes when in water", 5D);
