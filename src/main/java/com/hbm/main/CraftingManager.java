...
public class CraftingManager {
	...
	public static void AddCraftingRec() {
		...
		addRecipeAuto(new ItemStack(ModItems.asbestos_cloth, 2), new Object[] { "SCS", "CPC", "SCS", 'S', Items.string, 'P', ModItems.magnesium_chloride, 'C', Blocks.wool });
		...
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.VACUUM_TUBE), new Object[] { "G", "W", "I", 'G', KEY_ANYPANE, 'W', ModItems.rubidium_ingot, 'I', ModItems.plate_polymer });

		//rose red from rubidium (it's used in fireworks for a red color)
		addRecipeAuto(new ItemStack(Items.dye, 3, 1), new Object[] { "   ", "   ", " R ", 'R', ModItems.rubidium_ingot });

		//purple dye from rubidium
		addRecipeAuto(new ItemStack(Items.dye, 5, 5), new Object[] { "   ", "   ", "  R", 'R', ModItems.rubidium_ingot });
		...
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CAPACITOR, 4), new Object[] { "I", "N", "W", 'I', ModItems.plate_polymer, 'N', Sn.ingot(), 'W', CU.wireFine() });
		...
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.PCB, 16), new Object[] { "I", "P", 'I', ModItems.plate_polymer, 'P', PLATNIUM.ingot() });
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.PCB, 10), new Object[] { "I", "P", 'I', ModItems.plate_polymer, 'P', Ag.ingot() });
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.PCB), new Object[] { "I", "P", "S", 'I', ModItems.plate_polymer, 'P', Hg.ingot(), 'S', Items.redstone });
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.PCB, 4), new Object[] { "I", "P", "S", 'I', ModItems.plate_polymer, 'P', Se.dust(), 'S', Items.redstone });
		...
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP, 4), new Object[] { "I", "S", "W", 'I', Pd.ingot(), 'S', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.SILICON), 'W', CU.wireFine() });
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP, 4), new Object[] { "I", "S", "W", 'I', In.ingot(), 'S', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.SILICON), 'W', CU.wireFine() });
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP, 16), new Object[] { "I", "S", "W", 'I', PLATNIUM.ingot(), 'S', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.SILICON), 'W', CU.wireFine() });
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP, 4), new Object[] { "I", "S", "W", 'I', ModItems.nugget_germanium, 'S', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.SILICON), 'W', CU.wireFine() });
		...
		//strontium clocks are incredibly accurate
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ATOMIC_CLOCK, 16), new Object[] { "ICI", "CSC", "ICI", 'I', ModItems.plate_polymer, 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP), 'S', SR.dust() });
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ATOMIC_CLOCK, 16), new Object[] { "ICI", "CSC", "ICI", 'I', ModItems.plate_polymer, 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP), 'S', ModItems.ingot_ytterbium });

		//cesium
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ATOMIC_CLOCK, 1), new Object[] { "ICI", "CSC", "ICI", 'I', ModItems.plate_polymer, 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP), 'S', CS.dust() });

		//rubidium
		addRecipeAuto(DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ATOMIC_CLOCK, 1), new Object[] { "ICI", "CSC", "ICI", 'I', ModItems.plate_polymer, 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CHIP), 'S', ModItems.rubidium_ingot });
		...
		addRecipeAuto(new ItemStack(ModItems.coil_advanced_alloy, 16), new Object[] { "WWW", "WIW", "WWW", 'W', ALLOY.wireFine(), 'I', Tl.ingot() });
		addRecipeAuto(new ItemStack(ModItems.coil_advanced_alloy, 32), new Object[] { "WWW", "WIW", "WWW", 'W', ALLOY.wireFine(), 'I', Dy.ingot() });
		addRecipeAuto(new ItemStack(ModItems.coil_advanced_alloy, 32), new Object[] { "WWW", "WIW", "WWW", 'W', ALLOY.wireFine(), 'I', Ho.ingot() });
		...
		addRecipeAuto(new ItemStack(ModItems.coil_advanced_torus, 8), new Object[] { " C ", "CPC", " C ", 'P', Tl.ingot(), 'C', ModItems.coil_advanced_alloy });
		...
		addRecipeAuto(new ItemStack(ModItems.turbine_tungsten, 16), new Object[] { "BBB", "BSB", "BBB", 'B', ModItems.blade_tungsten, 'S', ModItems.ingot_dysprosium });
		...
		addShapelessAuto(new ItemStack(ModItems.teacup_empty, 16), new Object[] {Items.clay_ball, Items.water_bucket, Blocks.sand});
		...
		addShapelessAuto(new ItemStack(ModItems.pill_herbal), new Object[] { COAL.dust(), Items.poisonous_potato, DictFrame.fromOne(ModBlocks.plant_flower, EnumFlowerType.FOXGLOVE) });
		...
		addRecipeAuto(new ItemStack(Items.paper, 6), new Object[] { "SSS", 'S', ModItems.magnesium_chloride });
		...
		addRecipeAuto(new ItemStack(ModBlocks.red_wire_coated, 64), new Object[] { "WRW", "RIR", "WRW", 'W', ModItems.plate_polymer, 'I', ModItems.ingot_erbium, 'R', MINGRADE.wireFine() });
		...
		addRecipeAuto(new ItemStack(ModBlocks.red_cable_paintable, 64), new Object[] { "WRW", "RIR", "WRW", 'W', STEEL.plate(), 'I', ModItems.ingot_erbium, 'R', MINGRADE.wireFine() });
		addRecipeAuto(new ItemStack(ModBlocks.cable_switch, 1), new Object[] { "S", "W", 'S', Blocks.lever, 'W', ModBlocks.red_wire_coated });
		addRecipeAuto(new ItemStack(ModBlocks.cable_switch, 1), new Object[] { "S", "W", 'S', ModItems.ingot_mercury, 'W', ModBlocks.red_wire_coated });
		...
		addRecipeAuto(new ItemStack(ModBlocks.red_cable, 64), new Object[] { " W ", " R ", " W ", 'W', ModItems.plate_polymer, 'R', ModItems.ingot_erbium });
		...
		//bro you already have the firebox + stirling eng
		...
		addRecipeAuto(new ItemStack(ModBlocks.safe, 1), new Object[] { "LAL", "ACA", "LAL", 'L', PB.plate(), 'A', STAR.plate(), 'C', ModBlocks.crate_steel });
		...
		//since you wanted to pretend to be special
		// and not abide by known laws of physics you don't get a fucking recipe for your fan
		...
		addRecipeAuto(new ItemStack(ModItems.upgrade_template, 2), new Object[] { "WIW", "PCP", "WIW", 'W', CU.wireFine(), 'I', ANY_PLASTIC.ingot(), 'C', ModItems.nugget_ruthenium, 'P', ModItems.plate_polymer });
		...
		addRecipeAuto(DictFrame.fromOne(ModItems.arc_electrode, EnumElectrodeType.GRAPHITE), new Object[] { "C", "T", "C", 'C', PETCOKE.gem(), 'T', KEY_ANY_TAR });
		...
		addRecipeAuto(DictFrame.fromOne(ModItems.arc_electrode, EnumElectrodeType.DESH), new Object[] { "C", "T", "D", 'C', DESH.ingot(), 'T', W.ingot(), 'D', IRIDIUM.ingot() });
		...
		addRecipeAuto(new ItemStack(ModItems.blades_advanced_alloy, 1), new Object[] { " P ", "PIP", " P ", 'P', STAR.plate(), 'I', STAR.ingot() });
		//todo change to some steel alloy or some shit idk
		...
		addRecipeAuto(new ItemStack(ModItems.blades_advanced_alloy, 1), new Object[] { "PIP", 'P', STAR.plate(), 'I', new ItemStack(ModItems.blades_advanced_alloy, 1, OreDictionary.WILDCARD_VALUE) });
		...
		addRecipeAuto(new ItemStack(ModItems.mechanism_revolver_2, 1), new Object[] { "ATA", "TDT", "ATA", 'A', STAR.plate(), 'T', W.ingot(), 'D', DURA.ingot() });
		...
		for(int i = 0; i < 16; i++) {
			...
			//this must remain 8 because you are dying 8 pieces
		...
		addRecipeAuto(new ItemStack(Item.getItemFromBlock(ModBlocks.reinforced_light), 16), new Object[] { "FFF", "FBF", "FFF", 'F', Blocks.iron_bars, 'B', Blocks.glowstone });
		addRecipeAuto(new ItemStack(Item.getItemFromBlock(ModBlocks.reinforced_lamp_off), 16), new Object[] { "FFF", "FBF", "FFF", 'F', Blocks.iron_bars, 'B', Blocks.redstone_lamp });
		addRecipeAuto(new ItemStack(Item.getItemFromBlock(ModBlocks.reinforced_sand), 16), new Object[] { "FBF", "BFB", "FBF", 'F', Blocks.iron_bars, 'B', Blocks.sandstone });

		addShapelessAuto(new ItemStack(ModBlocks.lamp_tritium_green_off, 4), new Object[] { KEY_ANYGLASS, P_RED.dust(), Fluids.TRITIUM.getDict(1_000), S.dust() });
		addShapelessAuto(new ItemStack(ModBlocks.lamp_tritium_blue_off, 4), new Object[] {  KEY_ANYGLASS, P_RED.dust(), Fluids.TRITIUM.getDict(1_000), AL.dust() });
		addRecipeAuto(new ItemStack(ModBlocks.lantern, 8), new Object[] { "PGP", " S ", " S ", 'P', KEY_ANYPANE, 'G', Items.glowstone_dust, 'S', ModBlocks.steel_beam });
		...
		addRecipeAuto(new ItemStack(ModBlocks.spotlight_fluoro, 12), new Object[] { "G", "M", "A", 'G', KEY_ANYPANE, 'M', ModItems.nugget_europium, 'A', ModItems.plate_aluminium });
		...
		addRecipeAuto(new ItemStack(ModBlocks.floodlight, 4), new Object[] { "CSC", "TST", "G G", 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CAPACITOR), 'S', STEEL.plate(), 'T', ModItems.coil_tungsten, 'G', KEY_ANYPANE });

		addRecipeAuto(new ItemStack(ModBlocks.barbed_wire, 16), new Object[] { "AIA", "I I", "AIA", 'A', STEEL.wireFine(), 'I', IRON.ingot() });
		//I guess technically you could do this irl
...
//
		...
		addRecipeAuto(new ItemStack(ModBlocks.det_nuke, 1), new Object[] { "PFP", "DCD", "PFP", 'P', STEEL.plateCast(), 'D', ModBlocks.det_charge, 'C', ModItems.man_core, 'F', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.CONTROLLER) });
		addRecipeAuto(new ItemStack(ModBlocks.det_salt, 1), new Object[] {
			"PIP",
			"DCD",
			"POP",
			'P', ModItems.ingot_cobalt,
			'D', ModItems.billet_au198,
			'C', ModBlocks.det_nuke,
			'I', ModItems.ingot_zinc,
			'O', ModItems.ingot_tantalium
		...
		addShapelessAuto(new ItemStack(ModBlocks.charge_dynamite, 1), new Object[] { ModItems.stick_dynamite, ModItems.stick_dynamite, ModItems.stick_dynamite, ModItems.ducttape, DictFrame.fromOne(ModItems.circuit, EnumCircuitType.BASIC) });
		addRecipeAuto(new ItemStack(ModBlocks.charge_miner, 1), new Object[] { " F ", "FCF", " F ", 'F', ModItems.stick_dynamite, 'C', ModBlocks.charge_dynamite });
	...
	// Second recipe
		...
		addRecipeAuto(new ItemStack(ModItems.padlock_reinforced, 1), new Object[] { " P ", "PBP", "PDP", 'P', STAR.plate(), 'D', ModItems.plate_desh, 'B', DURA.bolt() });
		...
		//msrs corrode easily so steel alloy (saturnite) is used to make them.
		//addRecipeAuto(new ItemStack(ModBlocks.machine_molten_salt_reactor, 1), new Object[] { "PTP", "SCS", "PTP", 'P', DURA.pipe(), 'T', TH232.ingot(), 'S', BIGMT.plateCast(), 'C', ModBlocks.machine_geo });
		//addRecipeAuto(new ItemStack(ModBlocks.machine_msr_input, 2), new Object[] { "SPS", "PTP", "SPS", 'S', BIGMT.plateCast(), 'P', DURA.pipe(), 'T', TH232.ingot() });
		//addRecipeAuto(new ItemStack(ModBlocks.machine_msr_output, 2), new Object[] { "SPS", "PTP", "SPS", 'S', BIGMT.plateCast(), 'P', DURA.pipe(), 'T', TH232.ingot() });
		...
		addRecipeAuto(new ItemStack(ModItems.door_metal, 4), new Object[] { "II", "SS", "II", 'I', IRON.plate(), 'S', STEEL.plate() });
		addRecipeAuto(new ItemStack(ModItems.door_office, 4), new Object[] { "II", "SS", "II", 'I', KEY_PLANKS, 'S', IRON.plate() });
		addRecipeAuto(new ItemStack(ModItems.door_bunker, 4), new Object[] { "II", "SS", "II", 'I', STEEL.plate(), 'S', PB.plate() });
		...
		addShapelessAuto(new ItemStack(ModBlocks.barrel_iron, 1), new Object[] { ModBlocks.barrel_corroded, KEY_ANY_TAR });
		addRecipeAuto(new ItemStack(ModBlocks.barrel_steel, 1), new Object[] { "IPI", "I I", "IPI", 'I', STEEL.plate(), 'P', STEEL.ingot() });
		//WHERE IS THE COAL TAR COMING FROM, WHERE DOES IT GO? YOU FUCKING RETARD
		...
		addRecipeAuto(new ItemStack(ModItems.catalytic_converter, 1), new Object[] { "PCP", "PBP", "PRP", 'P', ANY_HARDPLASTIC.ingot(), 'C', CE.dust(), 'B', BI.ingot(), 'R', ModItems.powder_rhodium });
		...
		addRecipeAuto(new ItemStack(ModBlocks.hadron_coil_starmetal, 1), new Object[] { "SNS", "SCS", "SNS", 'S', STAR.ingot(), 'N', ModBlocks.hadron_coil_neodymium, 'C', ModBlocks.hadron_coil_alloy });
		addRecipeAuto(new ItemStack(ModBlocks.hadron_coil_starmetal, 1), new Object[] { "SW", "WS", 'W', ALLOY.wireDense(), 'S', STAR.wireDense() });
		...
		addRecipeAuto(new ItemStack(ModBlocks.rbmk_control_auto, 1), new Object[] { "CA", "R", "D", 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.PCB), 'A', ModItems.ingot_gadolinium, 'R', ModBlocks.rbmk_control, 'D', ModItems.crt_display });
		addRecipeAuto(new ItemStack(ModBlocks.rbmk_control_auto, 4), new Object[] { "CA", "R", "D", 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.PCB), 'A', ModItems.ingot_dysprosium, 'R', ModBlocks.rbmk_control, 'D', ModItems.crt_display });
		addRecipeAuto(new ItemStack(ModBlocks.rbmk_control_auto, 4), new Object[] { "CA", "R", "D", 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.PCB), 'A', ModItems.ingot_holmium, 'R', ModBlocks.rbmk_control, 'D', ModItems.crt_display });
		...
		addRecipeAuto(new ItemStack(ModBlocks.pwr_control, 8), new Object[] { "SBS", "MBM", "SBS", 'S', STEEL.plate528(), 'B', ModItems.ingot_europium, 'M', ModItems.motor });
		addRecipeAuto(new ItemStack(ModBlocks.pwr_control, 12), new Object[] { "SBS", "MBM", "SBS", 'S', STEEL.plate528(), 'B', ModItems.ingot_dysprosium, 'M', ModItems.motor });
		addRecipeAuto(new ItemStack(ModBlocks.pwr_control, 12), new Object[] { "SBS", "MBM", "SBS", 'S', STEEL.plate528(), 'B', ModItems.ingot_holmium, 'M', ModItems.motor });
		...
		addRecipeAuto(new ItemStack(ModBlocks.ladder_sturdy, 16), new Object[] { "LLL", "L#L", "LLL", 'L', Blocks.ladder, '#', KEY_PLANKS });
		addRecipeAuto(new ItemStack(ModBlocks.ladder_iron, 16), new Object[] { "LLL", "L#L", "LLL", 'L', Blocks.ladder, '#', IRON.ingot() });
		addRecipeAuto(new ItemStack(ModBlocks.ladder_gold, 8), new Object[] { "LLL", "L#L", "LLL", 'L', Blocks.ladder, '#', GOLD.ingot() });
		addRecipeAuto(new ItemStack(ModBlocks.ladder_aluminium, 16), new Object[] { "LLL", "L#L", "LLL", 'L', Blocks.ladder, '#', AL.ingot() });
		addRecipeAuto(new ItemStack(ModBlocks.ladder_copper, 16), new Object[] { "LLL", "L#L", "LLL", 'L', Blocks.ladder, '#', CU.ingot() });
		addRecipeAuto(new ItemStack(ModBlocks.ladder_titanium, 16), new Object[] { "LLL", "L#L", "LLL", 'L', Blocks.ladder, '#', TI.ingot() });
		addRecipeAuto(new ItemStack(ModBlocks.ladder_lead, 16), new Object[] { "LLL", "L#L", "LLL", 'L', Blocks.ladder, '#', PB.ingot() });
		addRecipeAuto(new ItemStack(ModBlocks.ladder_cobalt, 8), new Object[] { "LLL", "L#L", "LLL", 'L', Blocks.ladder, '#', CO.ingot() });
		addRecipeAuto(new ItemStack(ModBlocks.ladder_steel, 16), new Object[] { "LLL", "L#L", "LLL", 'L', Blocks.ladder, '#', STEEL.ingot() });
		addRecipeAuto(new ItemStack(ModBlocks.ladder_tungsten, 16), new Object[] { "LLL", "L#L", "LLL", 'L', Blocks.ladder, '#', W.ingot() });
		...
		//addRecipeAuto(new ItemStack(Items.name_tag), new Object[] { "SB ", "BPB", " BP", 'S', Items.string, 'B', KEY_ANY_TAR, 'P', Items.paper });
		...
		addShapelessAuto(new ItemStack(ModItems.book_guide, 1, BookType.SPACE.ordinal()), new Object[] { Items.book, ModItems.rp_fuselage_20_1 });
		...
		//TODO make this use electricity or something
		...
		addRecipeAuto(new ItemStack(ModBlocks.radar_screen, 2), new Object[] { "PCP", "SRS", "PCP", 'P', ANY_PLASTIC.ingot(), 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.BASIC), 'S', STEEL.plate(), 'R', ModItems.ingot_gadolinium });
		...
		addRecipeAuto(new ItemStack(ModBlocks.foundry_basin, 2), new Object[] { "B B", "B B", "BSB", 'B', ModItems.ingot_firebrick, 'S', Blocks.stone_slab });
		addRecipeAuto(new ItemStack(ModBlocks.foundry_mold, 2), new Object[] { "B B", "BSB", 'B', ModItems.ingot_firebrick, 'S', Blocks.stone_slab });
		addRecipeAuto(new ItemStack(ModBlocks.foundry_channel, 4), new Object[] { "B B", " S ", 'B', ModItems.ingot_firebrick, 'S', Blocks.stone_slab });
		addRecipeAuto(new ItemStack(ModBlocks.foundry_tank, 2), new Object[] { "B B", "I I", "BSB", 'B', ModItems.ingot_firebrick, 'I', STEEL.ingot(), 'S', Blocks.stone_slab });
		addShapelessAuto(new ItemStack(ModBlocks.foundry_outlet, 4), new Object[] { ModBlocks.foundry_channel, STEEL.plate() });
		addShapelessAuto(new ItemStack(ModBlocks.foundry_slagtap, 2), new Object[] { ModBlocks.foundry_channel, Blocks.stonebrick });
		addRecipeAuto(new ItemStack(ModItems.mold_base, 4), new Object[] { " B ", "BIB", " B ", 'B', ModItems.ingot_firebrick, 'I', IRON.ingot() });
		...
		addRecipeAuto(new ItemStack(ModBlocks.filing_cabinet, 4, DecoCabinetEnum.STEEL.ordinal()), new Object[] { " P ", "PIP", " P ", 'P', STEEL.plate(), 'I', ModItems.plate_polymer });
		...
		addShapelessAuto(new ItemStack(ModItems.bdcl), new Object[] { KEY_ANY_TAR, Fluids.WATER.getDict(1_000), KEY_WHITE });

		addShapelessAuto(new ItemStack(ModItems.galaxygas), new Object[] { Fluids.OXYGEN.getDict(1000), Fluids.NITROGEN.getDict(1_000), KEY_WHITE });
