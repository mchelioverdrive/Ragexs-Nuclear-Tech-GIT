...
public class ClientProxy extends ServerProxy {
	...
	public void registerTileEntitySpecialRenderer() {
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityNukeShrimp.class, new RenderNukeShrimp());
	...
	public void registerItemRenderer() {
		...
		//save//MinecraftForgeClient.registerItemRenderer(ModItems.gun_ks23, new ItemRenderWeaponKS23());
		...
		//inecraftForgeClient.registerItemRenderer(ModItems.gun_revolver_red, new ItemRenderWeaponNovac());
	...
	public void registerEntityRenderer() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityUAP.class, new RenderUAP());
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityFRIEND.class, new RenderFRIEND());
	...
	public void registerBlockRenderer() {
		...
		RenderingRegistry.registerBlockHandler(new RenderMSRPort());
		...
		RenderingRegistry.registerBlockHandler(new RenderBlockRotated(ModBlocks.charge_c4csgo.getRenderType(), ResourceManager.charge_c4));
