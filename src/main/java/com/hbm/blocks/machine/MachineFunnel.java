...
public class MachineFunnel extends BlockContainer implements ITooltipProvider, IRenderBlock {
	...
	public void renderInventory(Tessellator tessellator, Block block, int metadata) {
		...
		ObjUtil.renderPartWithIcon(ResourceManager.funnel, "Top", block.getIcon(1, 0), tessellator, 0, false);
		ObjUtil.renderPartWithIcon(ResourceManager.funnel, "Bottom", block.getIcon(0, 0), tessellator, 0, false);
		ObjUtil.renderPartWithIcon(ResourceManager.funnel, "Side", block.getIcon(2, 0), tessellator, 0, false);
		tessellator.draw();
	}
	...
	public void renderWorld(Tessellator tessellator, Block block, int meta, IBlockAccess world, int x, int y, int z) {
		...
		ObjUtil.renderPartWithIcon(ResourceManager.funnel, "Top", block.getIcon(1, 0), tessellator, 0, true);
		ObjUtil.renderPartWithIcon(ResourceManager.funnel, "Bottom", block.getIcon(0, 0), tessellator, 0, true);
		ObjUtil.renderPartWithIcon(ResourceManager.funnel, "Side", block.getIcon(2, 0), tessellator, 0, true);
		tessellator.addTranslation(-x - 0.5F, -y, -z - 0.5F);
	}
}
