...
public class NukeShrimp extends BlockContainer implements IBomb {

	public TileEntityNukeShrimp tetn = new TileEntityNukeShrimp();

	private final Random field_149933_a = new Random();
	private static boolean keepInventory = false;

	public NukeShrimp(Material p_i45386_1_) {
		super(p_i45386_1_);
	}

	@Override
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityNukeShrimp();
	}

	@Override
	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		return Item.getItemFromBlock(ModBlocks.nuke_shrimp);
	}

	@Override
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_) {
		if(!keepInventory) {
			TileEntityNukeShrimp tileentityfurnace = (TileEntityNukeShrimp) p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(world.isRemote) {
			...
			TileEntityNukeShrimp entity = (TileEntityNukeShrimp) world.getTileEntity(x, y, z);
			if(entity != null) {
	...
	public void onNeighborBlockChange(World p_149695_1_, int x, int y, int z, Block p_149695_5_) {
		...
		if(p_149695_1_.isBlockIndirectlyGettingPowered(x, y, z) && !p_149695_1_.isRemote) {
			...
			if(entity.isFilled()) {
				...
				entity.clearSlots();
				p_149695_1_.setBlockToAir(x, y, z);
				igniteTestBomb(p_149695_1_, x, y, z, BombConfig.shrimpRadius);
			}
		}
	}
	...
	public BombReturnCode explode(World world, int x, int y, int z) {
		...
		if(!world.isRemote) {
			...
			if(entity.isFilled()) {
				...
				entity.clearSlots();
				world.setBlockToAir(x, y, z);
				igniteTestBomb(world, x, y, z, BombConfig.shrimpRadius);
				return BombReturnCode.DETONATED;
			}
