...
public class TileEntityMachineDiesel extends TileEntityMachinePolluting implements IEnergyProviderMK2, IFluidStandardTransceiverMK2, IConfigurableMachine, IGUIProvider, IInfoProviderEC, IFluidCopiable {
	...
	public void updateEntity() {
		...
		if(!worldObj.isRemote) {
			...
			if(tank.setType(3, 4, slots)) this.untrySubscribeToAllAround(last, this);
