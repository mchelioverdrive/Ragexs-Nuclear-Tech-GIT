...
import com.hbm.inventory.container.ContainerNukeShrimp;
import com.hbm.inventory.gui.GUINukeMike;
import com.hbm.inventory.gui.GUINukeShrimp;
...
public class TileEntityNukeShrimp extends TileEntity implements ISidedInventory, IGUIProvider {

	private ItemStack slots[];
	private String customName;

	public TileEntityNukeShrimp() {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.customName : "container.nukeShrimp";
	}
	...
	public Container provideContainer(int ID, EntityPlayer player, World world, int x, int y, int z) {
		return new ContainerNukeShrimp(player.inventory, this);
	}

	@Override
	@SideOnly(Side.CLIENT)
	public Object provideGUI(int ID, EntityPlayer player, World world, int x, int y, int z) {
		return new GUINukeShrimp(player.inventory, this);
	}
