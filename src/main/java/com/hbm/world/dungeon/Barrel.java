...
public class Barrel extends WorldGenerator {
	...
	public boolean generate_r0(World world, Random rand, int x, int y, int z) {
		...
		world.setBlock(x + 2, y + 0, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 0, z + 0, Block2, 0, 3);
		world.setBlock(x + 0, y + 0, z + 1, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 4, y + 0, z + 1, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 0, z + 2, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 2, y + 0, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 0, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 1, z + 0, Block2, 0, 3);
		world.setBlock(x + 2, y + 1, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 1, z + 0, Block2, 0, 3);
		world.setBlock(x + 0, y + 1, z + 1, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 0, y + 1, z + 2, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 4, y + 1, z + 2, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 1, z + 3, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 2, y + 1, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 1, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 2, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 2, z + 0, Block2, 0, 3);
		world.setBlock(x + 3, y + 2, z + 0, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 4, y + 2, z + 1, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 2, z + 2, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 4, y + 2, z + 2, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 2, z + 3, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 4, y + 2, z + 3, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 2, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 2, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 2, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 3, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 3, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 3, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 3, z + 1, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 0, y + 3, z + 2, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 4, y + 3, z + 2, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 4, y + 3, z + 3, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 3, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 3, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 3, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 4, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 4, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 4, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 4, z + 1, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 4, y + 4, z + 1, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 4, z + 2, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 0, y + 4, z + 3, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 1, y + 4, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 4, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 4, z + 4, Block2, 0, 3);
		world.setBlock(x + 1, y + 5, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 5, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 5, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 5, z + 1, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 0, y + 5, z + 2, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 0, y + 5, z + 3, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 1, y + 5, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 5, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 5, z + 4, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 1, y + 7, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 7, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 7, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 7, z + 1, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 0, y + 7, z + 2, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 0, y + 7, z + 3, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 7, z + 3, Block12, 0, 3);
		world.setBlock(x + 2, y + 7, z + 3, Block12, 0, 3);
		world.setBlock(x + 3, y + 7, z + 3, Block12, 0, 3);
		world.setBlock(x + 4, y + 7, z + 3, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 7, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 7, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 7, z + 4, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 1, y + 9, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 9, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 9, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 9, z + 1, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 4, y + 9, z + 1, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 9, z + 2, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 4, y + 9, z + 2, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 9, z + 3, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 4, y + 9, z + 3, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 9, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 9, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 9, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 10, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 10, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 10, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 10, z + 1, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 4, y + 10, z + 1, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 10, z + 2, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 4, y + 10, z + 2, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 10, z + 3, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 4, y + 10, z + 3, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 10, z + 4, Library.getRandomConcrete(rand), 0, 3);
		//world.setBlock(x + 2, y + 10, z + 4, Blocks.iron_door, 2, 3);
		world.setBlock(x + 3, y + 10, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 11, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 11, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 11, z + 0, Library.getRandomConcrete(rand), 0, 3);
		...
		world.setBlock(x + 1, y + 11, z + 4, Library.getRandomConcrete(rand), 0, 3);
		//world.setBlock(x + 2, y + 11, z + 4, Blocks.iron_door, 8, 3);
        ItemDoor.placeDoorBlock(world, x + 2, y + 10, z + 4, 2, Blocks.iron_door);
		world.setBlock(x + 3, y + 11, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 12, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 12, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 12, z + 0, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 12, z + 1, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 4, y + 12, z + 1, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 12, z + 2, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 4, y + 12, z + 2, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 0, y + 12, z + 3, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 4, y + 12, z + 3, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 1, y + 12, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 2, y + 12, z + 4, Library.getRandomConcrete(rand), 0, 3);
		world.setBlock(x + 3, y + 12, z + 4, Library.getRandomConcrete(rand), 0, 3);
