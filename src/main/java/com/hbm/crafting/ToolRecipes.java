...
public class ToolRecipes {
	...
	public static void register() {
		...
		addPickaxe(	BBRONZE.ingot(), ModItems.alloy_pickaxe);
		addAxe(		BBRONZE.ingot(), ModItems.alloy_axe);
		addShovel(	BBRONZE.ingot(), ModItems.alloy_shovel);
		addHoe(		BBRONZE.ingot(), ModItems.alloy_hoe);
		...
		//idk what this is but it looks retarded so I'm nuking it out of the mod
		...
		//Drax
		//DRILL ITS A DRILL JUST CALL IT WHAT IT IS AND STOP RIPPING OFF TERRARIA
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.designator_manual, 1), new Object[] { "  A", "#C#", "#B#", '#', ANY_PLASTIC.ingot(), 'A', PB.plate(), 'B', ModItems.ingot_ytterbium, 'C', ModItems.designator });
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.geiger_counter, 1), new Object[] { "GPP", "WCS", "WBB", 'W', GOLD.wireFine(), 'P', ANY_RUBBER.ingot(), 'C', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.BASIC), 'G', ModItems.ingot_dysprosium, 'S', STEEL.plate528(), 'B', ModItems.ingot_beryllium });
