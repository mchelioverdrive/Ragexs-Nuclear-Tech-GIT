...
public class WeaponRecipes {
	...
	public static void register() {
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.mp_chip_3, 3), new Object[] { "P", "C", "S", 'P', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ANALOG), 'C', ModItems.ingot_gadolinium, 'S', ModBlocks.steel_scaffold });
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.mp_chip_4, 2), new Object[] { "P", "C", "S", 'P', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ANALOG), 'C', ModItems.ingot_gadolinium, 'S', ModBlocks.steel_scaffold });
		...
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.mp_chip_5, 8), new Object[] { "P", "C", "S", 'P', DictFrame.fromOne(ModItems.circuit, EnumCircuitType.ANALOG), 'C', ModItems.ingot_lutetium, 'S', ModBlocks.steel_scaffold });
		...
		//make more expensive and move to assembler
		//CraftingManager.addRecipeAuto(new ItemStack(ModItems.turret_light_ammo, 1), new Object[] { "LLL", "GGG", "CCC", 'L', PB.plate(), 'G', ModItems.cordite, 'C', CU.ingot() });
		//CraftingManager.addRecipeAuto(new ItemStack(ModItems.turret_light_ammo, 1), new Object[] { "LLL", "GGG", "CCC", 'L', PB.plate(), 'G', ModItems.ballistite, 'C', CU.ingot() });
		...
		//CraftingManager.addShapelessAuto(new ItemStack(ModItems.grenade_kyiv), new Object[] { ModItems.canister_napalm, ModItems.rag });
		...
		//Nuke parts
		CraftingManager.addRecipeAuto(new ItemStack(ModItems.n2_charge, 1), new Object[] { "XDX", "ERE", "XDX", 'D', ModItems.ducttape, 'E', ModBlocks.det_charge, 'R', REDSTONE.block(), 'X', ModItems.ammonium_nitrate });
