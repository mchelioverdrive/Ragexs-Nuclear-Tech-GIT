...
public class MineralRecipes {
	...
	public static void register() {
		...
		//magnesium
		add1To9Pair(ModItems.magnesium_ingot, ModItems.magnesium_nugget);
		...
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ModItems.pellet_rtg_promethium), new Object[] { ModItems.billet_pm, ModItems.billet_pm, ModItems.billet_pm, IRON.plate() }));
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.powder_niobium_tiny, 9), new Object[] { new ItemStack(ModItems.powder_niobium, 1) });
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.ingot_promethium, 1), new Object[] { "###", "###", "###", '#', ModItems.nugget_promethium });
		GameRegistry.addRecipe(new ItemStack(ModItems.nugget_promethium, 9), new Object[] { "#", '#', ModItems.ingot_promethium });
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.powder_combine_steel, 1), new Object[] { "###", "###", "###", '#', ModItems.powder_alien_tiny });
