...
public class OreDictManager {
	...
	//pam cancer
	//public static final DictFrame SALT = new DictFrame("Salt", "itemSalt", "dustSalt", "foodSalt");

	/*
	 * RADIOACTIVE
	 */
	public static final DictFrame U = new DictFrame(Compat.isModLoaded(Compat.MOD_GT6) ? "Uraninite" : "Uranium");
	public static final DictFrame Pm = new DictFrame("Promethium");
	...
	public static void registerOres() {
		...
		CDOLOMITE 															.ingot(calcined_dolomite);
		...
		CMB			.nugget(fragment_alien)														.ingot(ingot_combine_steel)											.dust(powder_combine_steel)		.plate(plate_combine_steel)		.block(block_combine_steel);
		...
		ND	.ingot(ingot_neodymium) .nugget(fragment_neodymium)																		.dustSmall(powder_neodymium_tiny)	.dust(powder_neodymium)									.ore(ore_depth_nether_neodymium)	.oreNether(ore_depth_nether_neodymium);
		CE	.explosive(4)  .hydro(2F).nugget(fragment_cerium)																		.dustSmall(powder_cerium_tiny)		.dust(powder_cerium);
