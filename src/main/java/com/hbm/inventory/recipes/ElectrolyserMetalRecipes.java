...
public class ElectrolyserMetalRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		recipes.put(new ComparableStack(ModItems.crystal_copper), new ElectrolysisMetalRecipe(
				...
				new ItemStack(ModItems.powder_selenium, 1),
				new ItemStack(ModItems.powder_tellurium_dioxide, 1),
		...
		// Raw tin ore is smelted through the existing furnace chain; electrorefining begins with the concentrated crystal feeds above.
