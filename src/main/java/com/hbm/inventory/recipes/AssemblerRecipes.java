...
public class AssemblerRecipes extends SerializableRecipe {
	...
	public void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_schrabidium_battery, 1), new AStack[] {new OreDictStack(DESH.ingot(), 16), new OreDictStack(NI.dust(), 12), new OreDictStack(CO.dust(), 12), new ComparableStack(ModBlocks.machine_lithium_battery,1) },800);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_fluidtank, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 2), new OreDictStack(STEEL.plate528(), 6), new OreDictStack(STEEL.shell(), 4), },150);
		makeRecipe(new ComparableStack(ModBlocks.machine_bat9000, 1), new AStack[] {new OreDictStack(STEEL.plate528(), 16), new OreDictStack(ANY_RESISTANTALLOY.plateWelded(), 2), new ComparableStack(ModBlocks.steel_scaffold, 16), },150);
		...
		makeRecipe(new ComparableStack(ModBlocks.nuke_shrimp, 1), new AStack[] {new ComparableStack(ModItems.sphere_steel, 1), new OreDictStack(AL.shell(), 4), new ComparableStack(ModItems.circuit, 12, EnumCircuitType.CONTROLLER_ADVANCED), new OreDictStack("dyeLightGray", 16), },600);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_flare, 1), new AStack[] {new ComparableStack(Items.glowstone_dust, 1), new OreDictStack(AL.plate(), 2), },100);
		...
		makeRecipe(new ComparableStack(ModItems.rp_fuselage_20_12, 1), new AStack[] {new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModBlocks.steel_scaffold, 16), new OreDictStack(TI.shell(), 12), new OreDictStack(AL.plateWelded(), 16), },1200);
		makeRecipe(new ComparableStack(ModItems.rp_fuselage_20_6, 1), new AStack[] {new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModBlocks.steel_scaffold, 8), new OreDictStack(TI.shell(), 6), new OreDictStack(AL.plateWelded(), 8), },1200);
		makeRecipe(new ComparableStack(ModItems.rp_fuselage_20_3, 1), new AStack[] {new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModBlocks.steel_scaffold, 4), new OreDictStack(TI.shell(), 3), new OreDictStack(AL.plateWelded(), 4), },1200);
		makeRecipe(new ComparableStack(ModItems.rp_fuselage_20_1, 1), new AStack[] {new ComparableStack(ModItems.seg_20, 1), new ComparableStack(ModBlocks.steel_scaffold, 2), new OreDictStack(TI.shell(), 1), new OreDictStack(AL.plateWelded(), 2), },1200);
		makeRecipe(new ComparableStack(ModItems.rp_fuselage_20_12_hydrazine, 1), new AStack[] {new ComparableStack(ModItems.seg_20, 1), new OreDictStack(TI.shell(), 12), new OreDictStack(AL.plateWelded(), 16), new OreDictStack(POLYMER.ingot(), 8) },1200); //needs teflon because its inert to such a hypergolic fuel
		...
		makeRecipe(new ComparableStack(ModItems.sat_lunar_miner, 1), new AStack[] {
				new ComparableStack(ModItems.ingot_chainsteel, 16),
				new ComparableStack(ModItems.plate_desh, 4),
...
//
		...
		makeRecipe(new ComparableStack(ModBlocks.turret_howard, 1), new AStack[] {
				new ComparableStack(ModBlocks.machine_battery, 1),
				new OreDictStack(STEEL.ingot(), 32),
				new OreDictStack(DURA.ingot(), 8),
				new ComparableStack(ModItems.motor, 5),
				//new ComparableStack(ModItems.motor_desh, 2),
				new ComparableStack(ModItems.circuit, 6, EnumCircuitType.ADVANCED),
				new OreDictStack(STEEL.pipe(), 15),
				new ComparableStack(ModItems.mechanism_rifle_2, 4),
				new ComparableStack(ModBlocks.crate_steel, 1),
				new ComparableStack(ModItems.crt_display, 1)
			}, 1200);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_lpw2, 1), new AStack[] {
				...
				new ComparableStack(ModItems.circuit, 1, EnumCircuitType.ADVANCED),
				new OreDictStack(CU.pipe(), 4),
				new ComparableStack(ModBlocks.machine_htr3, 1),
		}, 400);
		makeRecipe(new ComparableStack(ModBlocks.machine_htr3, 1), new AStack[] {
				new OreDictStack(ANY_RESISTANTALLOY.plateWelded(), 8),
				new OreDictStack(DURA.bolt(), 16),
