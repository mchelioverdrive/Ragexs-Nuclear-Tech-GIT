...
public class SILEXRecipes {
	...
	public static void register() {
		...
		recipes.put(U.ingot(), new SILEXRecipe(900, 100, EnumWavelengths.IR)
			.addOut(new ItemStack(ModItems.nugget_u235), 2)   // enriched fraction
			.addOut(new ItemStack(ModItems.nugget_u238), 10)  // depleted bulk
		);

		recipes.put(new ComparableStack(ModItems.ingot_pu_mix),
			new SILEXRecipe(900, 100, EnumWavelengths.IR)
				.addOut(new ItemStack(ModItems.nugget_pu239), 5) // slightly favored
				.addOut(new ItemStack(ModItems.nugget_pu240), 4)
				.addOut(new ItemStack(ModItems.nugget_pu238), 1)
		);

		recipes.put(new ComparableStack(ModItems.ingot_am_mix),
			new SILEXRecipe(900, 100, EnumWavelengths.IR)
				.addOut(new ItemStack(ModItems.nugget_am241), 4)
				.addOut(new ItemStack(ModItems.nugget_am242), 5)
		);

		recipes.put(new ComparableStack(ModItems.ingot_cm_mix),
			new SILEXRecipe(900, 100, EnumWavelengths.IR)
				.addOut(new ItemStack(ModItems.nugget_cm245), 4)
				.addOut(new ItemStack(ModItems.nugget_cm244), 5)
		);
		...
		//cf249 from cf_light_fraction
		//itemTranslation.put(new ComparableStack(ModItems.cf_light_fraction), new ComparableStack(ModItems.ingot_cf249));

		//recipes.put(new ComparableStack(ModItems.cf_light_fraction, 1, new SILEXRecipe(900, 100, 2)
		//	.addOut(new ItemStack(ModItems.nugget_cf249), 25)
		//	.addOut(new ItemStack(ModItems.nugget_cf250), 25)
		//	.addOut(new ItemStack(ModItems.nugget_cf251), 25)
		//	.addOut(new ItemStack(ModItems.nugget_cf252), 25)
		//);

		recipes.put(new ComparableStack(ModItems.cf_light_fraction),
			new SILEXRecipe(1200, 100, EnumWavelengths.IR)
				.addOut(new ItemStack(ModItems.nugget_cf249), 3)   // enriched target
				.addOut(new ItemStack(ModItems.nugget_cf250), 4)   // it's okay you'll have a use soon... I lied. LOL enjoy your waste product
				.addOut(new ItemStack(ModItems.nugget_cf251), 2)   // heavier carryover
		);
		...
		//);
		//chemical decomposition, not isotope separation.
...
////				.addOut(new ItemStack(ModItems.nuclear_waste_short_tiny, 1, ItemWasteShort.WasteClass.CURIUM245.ordinal()), 7 + 8 * i));
//
//			//AND THE WOMEN. AND THE CHILDREN TOO. SLAUGHTERED. LIKE ANIMALS.
//		}
