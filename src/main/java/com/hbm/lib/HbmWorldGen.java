...
//
		...
		if(WorldConfig.overworldOre) {
			...
			DungeonToolbox.generateOre(world, rand, i, j, WorldConfig.potashSpawn, 6, 5, 32, ModBlocks.ore_potash);
			DungeonToolbox.generateOre(world, rand, i, j, WorldConfig.polluciteSpawn, 4, 5, 30, ModBlocks.ore_pollucite);
			DungeonToolbox.generateOre(world, rand, i, j, WorldConfig.polluciteSpawn, 6, 5, 30, ModBlocks.ore_tin);
			DungeonToolbox.generateOre(world, rand, i, j, WorldConfig.magnesiteSpawn, 4, 5, 30, ModBlocks.ore_magnesite);

			// DungeonToolbox.generateOre(world, rand, i, j, WorldConfig.mineralSpawn, 10, 12, 32, ModBlocks.ore_mineral);
			//DungeonToolbox.generateOre(world, rand, i, j, WorldConfig.siliconSpawn, 4, 5, 45, ModBlocks.ore_silicon);
			DungeonToolbox.generateOre(world, rand, i, j, WorldConfig.quartzSpawn, 4, 5, 50, ModBlocks.ore_quartz);
			...
			DungeonToolbox.generateOre(world, rand, i, j, WorldConfig.celestiteSpawn, 12, 5, 50, ModBlocks.ore_celestite);
			...
			if(rand.nextInt(3) == 0) {
				...
				int randPosX = i + rand.nextInt(2) + 11;
				int randPosZ = j + rand.nextInt(2) + 11;
			...
			if((GeneralConfig.enable528BedrockSpawn || GeneralConfig.enable528BedrockDeposit) && rand.nextInt(GeneralConfig.bedrockRate) != 0) {
				int x = i + rand.nextInt(10) + 11;
				int z = j + rand.nextInt(10) + 11;
...
//
			...
			if (WorldConfig.geyserChlorine > 0 && biome == BiomeGenBase.plains && rand.nextInt(WorldConfig.geyserWater) == 0) {
				int x = i + 10 + rand.nextInt(12);
				int z = j + 10 + rand.nextInt(12);
				int y = world.getHeightValue(x, z);
			...
			if (WorldConfig.geyserWater > 0 && biome == BiomeGenBase.desert && rand.nextInt(WorldConfig.geyserChlorine) == 0) {
				int x = i + 12 + rand.nextInt(8);
				int z = j + 12 + rand.nextInt(8);
				int y = world.getHeightValue(x, z);
