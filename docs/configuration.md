...
Linearized world depth provides continuous distance-based scotopic perception: NEAR is approximately 0–5 blocks, MID approximately 5–20 blocks, and FAR approximately 20–50+ blocks. Nearby terrain retains the most coarse texture, while blur and local-contrast loss increase smoothly through MID until FAR primarily preserves silhouettes and large forms. The final recovered-visibility transition is a smooth fade rather than a hard cutoff. Better environmental ambient light and stronger eye adaptation extend every useful range; poor conditions contract them.
