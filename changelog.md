## Fix RTM ring tessellator calls

- Replaced invalid five-argument ring `addVertex` calls with RTM-compatible three-coordinate tessellator vertices while texture drawing is disabled.
